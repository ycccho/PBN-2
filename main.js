const app = {
    ...
    posts: [
        {
            id: 1,
            title: "부산 해운대구 수학학원 인테리어 시공 사례 - 학습 효율 극대화",
            image: "", // 이미지 URL 입력 가능
            description: "해운대구 수학학원의 집중력을 높이는 인테리어 디자인 사례입니다.",
            content: `
                <p><b>부산 해운대구 수학학원</b> 인테리어 현장입니다. 학생들의 학습 몰입도를 높이기 위해 차분한 블루와 그레이 톤을 매칭하였습니다.</p>
                <p>강의실마다 방음 시공을 철저히 진행하였으며, 눈의 피로도를 낮추는 간접 조명 설계를 적용했습니다. 공간의 효율적인 분리를 통해 면적 대비 많은 강의실을 확보한 것이 특징입니다.</p>
                <p><a href="https://inde.co.kr" target="_blank"><b>부산 학원 인테리어 견적 상담 바로가기</b></a></p>
            `
        },
        {
            id: 2,
